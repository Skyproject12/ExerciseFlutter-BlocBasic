...
import 'package:weather_block/bloc/WeatherBlock.dart';
import 'package:weather_block/model/WeatherModel.dart';
import 'package:weather_block/persistance/WeatherRepo.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        home: Scaffold(
            ...
            // melakukan return block
            body: BlocProvider( 
              // call weather repo call weather block 
      ...
      children: <Widget>[
        ...
        BlocBuilder<WeatherBloc, WeatherState>(builder: (context, state) {
          if (state is WeatherIsNotSearched)
            ...
            return Text("Error"+cityController.text, style: TextStyle(color: Colors.white),);
        })
      ],
    );
  }
        ...
        children: <Widget>[ 
          ...
          Row(
            ...
            children: <Widget>[  
              ...
              Column( 
                children: <Widget>[ 
                  Text(weather.getMaxTemp.round().toString()+"C", style: TextStyle(color:Colors.white70, fontSize: 30.0)), 
